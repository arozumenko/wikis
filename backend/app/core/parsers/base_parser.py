...
class Symbol:
    ...
    parent_symbol: str | None = None  # Parent class/function name
    full_name: str | None = None  # Fully qualified name
    ...
    # Additional context
    source_text: str | None = None  # Full source code of the symbol
    signature: str | None = None  # Method/function signature
...
class Relationship:
    ...
    # Context information
    source_file: str
    target_file: str | None = None  # May be in different file
    source_range: Range | None = None  # Where relationship occurs in source
...
class ParseResult:
    ...
    file_hash: str | None = None  # For caching
    parse_time: float | None = None  # Performance tracking
...
class BaseParser(ABC):
    ...
    def validate_result(self, result: ParseResult) -> ParseResult:
        ...
        for relationship in result.relationships:
            source_ok = relationship.source_symbol in all_symbol_identifiers or relationship.source_symbol == file_stem
...
class ParserRegistry:
    ...
    def get_language_capabilities(self, language: str) -> LanguageCapabilities | None:
        """
